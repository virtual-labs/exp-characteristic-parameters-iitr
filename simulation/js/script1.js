...
function ic741() {
    ...
    {
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_8', 'ic741_81', [0, 0, 1, -1, 11, 5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_8', 'ic741_82', [0, 0, 1, -1, 11, 18.5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_8', 'ic741_83', [0, 0, 1, -1, 11, 32], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_8', 'ic741_84', [0, 0, 1, -1, 11, 45.5], 'red');
  //      ic7404.addEndPoint(4.2,1, 'ic7404', 'ic7404_VCC', 'ic7404_VCC5', [0, 0, 1, -1, 5, 54], 'red');

        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_7', 'ic741_71', [0, 0, 1, -1, 24.5, 5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_7', 'ic741_72', [0, 0, 1, -1, 24.5, 18.5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_7', 'ic741_73', [0, 0, 1, -1, 24.5, 32], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_7', 'ic741_74', [0, 0, 1, -1, 24.5, 45.5], 'red');
     //  ic7404.addEndPoint(4.2,1, 'ic7404', 'ic7404_6A', 'ic7404_6A05', [0, 0, 1, -1, 18.5, 54], 'red');

        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_6', 'ic741_61', [0, 0, 1, -1, 38, 5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_6', 'ic741_62', [0, 0, 1, -1, 38, 18.5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_6', 'ic741_63', [0, 0, 1, -1, 38, 32], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_6', 'ic741_64', [0, 0, 1, -1, 38, 45.5], 'red');
   //     ic7404.addEndPoint(4.2,1, 'ic7404', 'ic7404_6Y', 'ic7404_6Y05', [0, 0, 1, -1, 32, 54], 'red');

        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_5', 'ic741_51', [0, 0, 1, -1, 51.5, 5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_5', 'ic741_52', [0, 0, 1, -1, 51.5, 18.5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_5', 'ic741_53', [0, 0, 1, -1, 51.5, 32], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_5', 'ic741_54', [0, 0, 1, -1, 51.5, 45.5], 'red');
 
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_1', 'ic741_11', [0, 0, 1, -1, 11, 112.5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_1', 'ic741_12', [0, 0, 1, -1, 11, 126], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_1', 'ic741_13', [0, 0, 1, -1, 11, 139.5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_1', 'ic741_14', [0, 0, 1, -1, 11, 153], 'red');

   //     ic7404.addEndPoint(4.2,1, 'ic7404', 'ic7404_1Y', 'ic7404_1Y01', [0, 0, 1, -1, 18.5, 94], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_2', 'ic741_21', [0, 0, 1, -1, 24.5, 112.5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_2', 'ic741_22', [0, 0, 1, -1, 24.5, 126], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_2', 'ic741_23', [0, 0, 1, -1, 24.5, 139.5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_2', 'ic741_24', [0, 0, 1, -1, 24.5, 153], 'red');

      //  ic7404.addEndPoint(4.2,1, 'ic7404', 'ic7404_2A', 'ic7404_2A01', [0, 0, 1, -1, 32, 94], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_3', 'ic741_31', [0, 0, 1, -1, 38, 112.5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_3', 'ic741_32', [0, 0, 1, -1, 38, 126], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_3', 'ic741_33', [0, 0, 1, -1, 38, 139.5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_3', 'ic741_34', [0, 0, 1, -1, 38, 153], 'red');

   //     ic7404.addEndPoint(4.2,1, 'ic7404', 'ic7404_2Y', 'ic7404_2Y01', [0, 0, 1, -1, 45.5, 94], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_4', 'ic741_41', [0, 0, 1, -1, 51.5, 112.5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_4', 'ic741_42', [0, 0, 1, -1, 51.5, 126], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_4', 'ic741_43', [0, 0, 1, -1, 51.5, 139.5], 'red');
        ic741.addEndPoint('green',4.2,1, 'ic741', 'ic741_4', 'ic741_44', [0, 0, 1, -1, 51.5, 153], 'red');
...
{
    supply.addEndPoint('red',7,1, 'supply', 'VCC', 'VCC', [0, 0, 0, 0, 64, 65], 'red');
    supply.addEndPoint('green',7,1, 'supply', 'GND', 'GND', [0, 0, 0, 0, 110, 66], 'green');
    supply.addEndPoint('blue',7,1, 'supply', 'VEE', 'VEE', [0, 0, 0, 0, 155, 65], 'blue');
}
disabledButton();
}
function capacitor() {
  ...
  {//  led.addEndPoint(4.2,1, 'led1', 'led_C1', 'led_C101', [0, 0, 0, 1, 3, 62], 'red');
    cap.addEndPoint('green',4.2,1, 'cap', 'cap_C1', 'cap_C101', [0, 0, 1, -1, 27, 128], 'red');
    cap.addEndPoint('green',4.2,1, 'cap', 'cap_C1', 'cap_C102', [0, 0, 1, -1, 27, 142], 'red');
    cap.addEndPoint('green',4.2,1, 'cap', 'cap_C1', 'cap_C103', [0, 0, 1, -1, 27, 156], 'red');
    cap.addEndPoint('green',4.2,1, 'cap', 'cap_C1', 'cap_C104', [0, 0, 1, -1, 27, 168], 'red');

    cap.addEndPoint('green',4.2,1, 'cap', 'cap_A1', 'cap_A101', [0, 0, 1, -1, 0.5, 128], 'red');
    cap.addEndPoint('green',4.2,1, 'cap', 'cap_A1', 'cap_A102', [0, 0, 1, -1, 0.5, 142], 'red');
    cap.addEndPoint('green',4.2,1, 'cap', 'cap_A1', 'cap_A103', [0, 0, 1, -1, 0.5, 156], 'red');
    cap.addEndPoint('green',4.2,1, 'cap', 'cap_A1', 'cap_A104', [0, 0, 1, -1, 0.5, 168], 'red');
...
{
  //  led.addEndPoint(4.2,1, 'led1', 'led_C1', 'led_C101', [0, 0, 0, 1, 3, 62], 'red');
    cap1.addEndPoint('green',4.2,1, 'cap1', 'cap_C11', 'cap_C111', [0, 0, 1, -1, 28, 128], 'red');
    cap1.addEndPoint('green',4.2,1, 'cap1', 'cap_C11', 'cap_C112', [0, 0, 1, -1, 28, 142], 'red');
    cap1.addEndPoint('green',4.2,1, 'cap1', 'cap_C11', 'cap_C113', [0, 0, 1, -1, 28, 156], 'red');
    cap1.addEndPoint('green',4.2,1, 'cap1', 'cap_C11', 'cap_C114', [0, 0, 1, -1, 28, 168], 'red');


    cap1.addEndPoint('green',4.2,1, 'cap1', 'cap_A11', 'cap_A111', [0, 0, 1, -1, 2, 128], 'red');
    cap1.addEndPoint('green',4.2,1, 'cap1', 'cap_A11', 'cap_A112', [0, 0, 1, -1, 2, 142], 'red');
    cap1.addEndPoint('green',4.2,1, 'cap1', 'cap_A11', 'cap_A113', [0, 0, 1, -1, 2, 156], 'red');
    cap1.addEndPoint('green',4.2,1, 'cap1', 'cap_A11', 'cap_A114', [0, 0, 1, -1, 2, 168], 'red');
...
{
  //  led.addEndPoint(4.2,1, 'led1', 'led_C1', 'led_C101', [0, 0, 0, 1, 3, 62], 'red');
    cap2.addEndPoint('green',4.2,1, 'cap2', 'cap_C21', 'cap_C211', [0, 0, 1, -1, 28, 128], 'red');
    cap2.addEndPoint('green',4.2,1, 'cap2', 'cap_C21', 'cap_C212', [0, 0, 1, -1, 28, 142], 'red');
    cap2.addEndPoint('green',4.2,1, 'cap2', 'cap_C21', 'cap_C213', [0, 0, 1, -1, 28, 156], 'red');
    cap2.addEndPoint('green',4.2,1, 'cap2', 'cap_C21', 'cap_C214', [0, 0, 1, -1, 28, 168], 'red');


    cap2.addEndPoint('green',4.2,1, 'cap2', 'cap_A21', 'cap_A211', [0, 0, 1, -1, 2, 128], 'red');
    cap2.addEndPoint('green',4.2,1, 'cap2', 'cap_A21', 'cap_A212', [0, 0, 1, -1, 2, 142], 'red');
    cap2.addEndPoint('green',4.2,1, 'cap2', 'cap_A21', 'cap_A213', [0, 0, 1, -1, 2, 156], 'red');
    cap2.addEndPoint('green',4.2,1, 'cap2', 'cap_A21', 'cap_A214', [0, 0, 1, -1, 2, 168], 'red');
...
function resistor2() {
  ...
  //  led.addEndPoint(4.2,1, 'led1', 'led_C1', 'led_C101', [0, 0, 0, 1, 3, 62], 'red');
    resistance2.addEndPoint('green',4.2,1, 'resistance2', 'resistance2_C1', 'resistance2_C101', [0, 0, 1, -1, 8, -47], 'red');
    resistance2.addEndPoint('green',4.2,1, 'resistance2', 'resistance2_C1', 'resistance2_C102', [0, 0, 1, -1, 8, -33], 'red');
    resistance2.addEndPoint('green',4.2,1, 'resistance2', 'resistance2_C1', 'resistance2_C103', [0, 0, 1, -1, 8, -19], 'red');
    resistance2.addEndPoint('green',4.2,1, 'resistance2', 'resistance2_C1', 'resistance2_C104', [0, 0, 1, -1, 8, -5], 'red');

    resistance2.addEndPoint('green',4.2,1, 'resistance2', 'resistance2_A1', 'resistance2_A101', [0, 0, 1, -1, 8, 61], 'red');
    resistance2.addEndPoint('green',4.2,1, 'resistance2', 'resistance2_A1', 'resistance2_A102', [0, 0, 1, -1, 8, 75], 'red');
    resistance2.addEndPoint('green',4.2,1, 'resistance2', 'resistance2_A1', 'resistance2_A103', [0, 0, 1, -1, 8, 89], 'red');
    resistance2.addEndPoint('green',4.2,1, 'resistance2', 'resistance2_A1', 'resistance2_A104', [0, 0, 1, -1, 8, 103], 'red');
...
function resistor5() {
  ...
  //  led.addEndPoint(4.2,1, 'led1', 'led_C1', 'led_C101', [0, 0, 0, 1, 3, 62], 'red');
    resistance5.addEndPoint('green',4.2,1, 'resistance5', 'resistance5_C1', 'resistance5_C101', [0, 0, 1, -1, 11, -47], 'red');
    resistance5.addEndPoint('green',4.2,1, 'resistance5', 'resistance5_C1', 'resistance5_C102', [0, 0, 1, -1, 11, -33], 'red');
    resistance5.addEndPoint('green',4.2,1, 'resistance5', 'resistance5_C1', 'resistance5_C103', [0, 0, 1, -1, 11, -19], 'red');
    resistance5.addEndPoint('green',4.2,1, 'resistance5', 'resistance5_C1', 'resistance5_C104', [0, 0, 1, -1, 11, -5], 'red');

    resistance5.addEndPoint('green',4.2,1, 'resistance5', 'resistance5_A1', 'resistance5_A101', [0, 0, 1, -1, 11, 61], 'red');
    resistance5.addEndPoint('green',4.2,1, 'resistance5', 'resistance5_A1', 'resistance5_A102', [0, 0, 1, -1, 11, 75], 'red');
    resistance5.addEndPoint('green',4.2,1, 'resistance5', 'resistance5_A1', 'resistance5_A103', [0, 0, 1, -1, 11, 89], 'red');
    resistance5.addEndPoint('green',4.2,1, 'resistance5', 'resistance5_A1', 'resistance5_A104', [0, 0, 1, -1, 11, 103], 'red');
...
function multimeter()
{
    ...
    multimeter.addEndPoint('red',7,1, 'shape', 'multimeter_VCC', 'multimeter_VCC1', [0, 0, 1,-1, 880, 12], 'red');
    multimeter.addEndPoint('black',7,1, 'shape', 'multimeter_GND', 'multimeter_GND1', [0, 0, 1, -1, 845,12], 'black');
...
function disabledButton()
{
  ...
  if(window.getComputedStyle(document.getElementById('board')).visibility === "visible" && 
  (window.getComputedStyle(document.getElementById('res1')).visibility === "visible" ||  window.getComputedStyle(document.getElementById('res2')).visibility === "visible" || 
  window.getComputedStyle(document.getElementById('res3')).visibility === "visible" || window.getComputedStyle(document.getElementById('res4')).visibility === "visible" || 
  window.getComputedStyle(document.getElementById('res5')).visibility === "visible")  && window.getComputedStyle(document.getElementById('supply')).visibility === "visible" && 
  (window.getComputedStyle(document.getElementById('shape')).visibility === "visible" || window.getComputedStyle(document.getElementById('cro2')).visibility === "visible") && 
  (window.getComputedStyle(document.getElementById('cap')).visibility === "visible"  || window.getComputedStyle(document.getElementById('cap1')).visibility === "visible" || 
  window.getComputedStyle(document.getElementById('cap2')).visibility === "visible" ||  window.getComputedStyle(document.getElementById('generator')).visibility === "visible")&& 
  window.getComputedStyle(document.getElementById('ic741')).visibility === "visible" )
  {
...
{    
  document.getElementById('head').innerHTML += " : Measurement of inverting bias current";
...
{
  document.getElementById('head').innerHTML += " : Measurement of non-inverting bias current";
     var a= document.getElementById("showanother");
     a.style.visibility="hidden";
...
{ var z=document.getElementById("sel2").value;
    if(z=="first")
    {
         ...
         var y= document.getElementById("chooseone");
         y.style.visibility="hidden";
         var z= document.getElementById("heading");
   ...
   document.getElementById("resetbutton").disabled=false;
     ...
     document.getElementById('head').innerHTML += " : Measurement of input offset current";
...
calculate3();
   ...
   supply();
     ...
     else if(z=="third")
    {
      ...
      z.style.visibility="hidden";
    document.getElementById("resetbutton").disabled=false;
    document.getElementById('head').innerHTML += " : Measurement of input offset voltage";
     var y= document.getElementById("chooseone");
   y.style.visibility="hidden";
     document.getElementById('resistancebutton').innerHTML = "Resistors";
...
calculate4();
   ...
   supply();
     ...
     else if(z=="fourth")
    {
     ...
     var z= document.getElementById("heading");
     z.style.visibility="hidden";
     document.getElementById('head').innerHTML += " : Measurement of slew rate";
     document.getElementById("resetbutton").disabled=false;
  ...
  document.getElementById("capbutton").innerHTML="A.F. Oscillator";
   ...
   document.getElementById("switchbutton").style.height="40px"
  document.getElementById("resistancebutton").addEventListener("click", function(){
...
function generator1()
{
  ...
  generator.setCircuitContainer('mid');
    ...
    generator.addEndPoint('black',5,1, 'generator', 'generator_C1', 'generator_C101', [0, 0, 1, -1, 188, 97], 'black');
    generator.addEndPoint('red',5,1, 'generator', 'generator_A1', 'generator_A101', [0, 0, 1, -1, 154, 97], 'red');
